...
public abstract class Product {
    ...
    public void setName(String name) throws ProductException {
        if (Objects.equals(name, "") | name==null) {throw new ProductException(ProductException.ERR_WRONG_NAME);}
        this.name = name;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Product) {
            ...
            //Checks
            return (super.equals(obj) | (Objects.equals(pObj.name, this.name) &  pObj.getClass().equals(this.getClass())));
        }
        return false;
    }
}
